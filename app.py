...
cred = credentials.Certificate("./iuh-20017171-firebase-adminsdk-q0r5g-195f3e10ea.json")
app = firebase_admin.initialize_app(cred)
dbFireStore = firestore.client()

queryResults = list(dbFireStore.collection(u'tbl-20017171').stream())
                ...
                html.Nav(
                    ...
                    children=html.H2(
                        children=["DANH MỤC SẢN PHÂM TIỀM NĂNG",
                                  ...
                                  html.Br(), html.H5(
                                      children="Nguyễn Thị Kim Yến - 20017171"
                                  )
                                  ],
